      ...
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between lg:space-x-6 gap-y-16 lg:gap-y-0 mb-16">
        <div className="text-center">
          <a href="https://toagym.es" className="group" target="_blank">
            <Image width={2886} height={1806} src="/toagym.png" className="w-100 max-w-1/2 group-hover:scale-110 duration-200" alt="Toagym website screenshot" />
          </a>
        ...
        <div className="text-center">
          <a href="https://github.com/dresnite/skyblock" className="group" target="_blank">
            <Image width={2886} height={1806} src="/skyblock.png" className="w-100 max-w-1/2 group-hover:scale-110 duration-200" alt="Toagym website screenshot" />
          </a>
